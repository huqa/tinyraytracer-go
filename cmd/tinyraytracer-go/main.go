...
func main() {
	fmt.Println("tinyraytracer-go v0.07")

	ivory := object.NewMaterial(vector.NewVector3(0.6, 0.3, 0.1), vector.NewVector3(0.4, 0.4, 0.3), 50.0)
	redRubber := object.NewMaterial(vector.NewVector3(1.9, 0.1, 0.0), vector.NewVector3(0.3, 0.1, 0.1), 5.0)
	mirror := object.NewMaterial(vector.NewVector3(0.0, 10.0, 0.8), vector.NewVector3(1.0, 1.0, 1.0), 1425.0)
	...
	spheres = append(spheres, object.NewSphere(vector.NewVector3(-1.0, -1.5, -12), 2, mirror))
